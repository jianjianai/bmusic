...
import { musicPlayers, type MusicSearchComponent } from '../musicPlayers/musicPlayers';
...
<template>
    <div class="search-contents-main-box">
        ...
        <div class="player-search-greps">
            <div class="player-search" v-for="player of searchPlayers" @click="currentPlayer=player" :class="{on:player.key==currentPlayer?.key}">
