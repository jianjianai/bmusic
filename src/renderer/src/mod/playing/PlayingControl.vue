...
import Contr from './unit/Contr.vue';
import { musicPlayer, musicPlayerButtomWidth, musicPlayerSize, playerLeftCustomButtons, playerRightCustomButtons } from './playing';
...
<template>
    <div class="player-bottom-control" :class="musicPlayerSize">
        <!-- 左边 -->
        ...
        <!-- 中间播放控制器 -->
        <Contr class="player-control-grep"></Contr>
        <!-- 右边 -->
...
.player-bottom-control.buttom .left-control::before {
    /* width: 9rem; */
